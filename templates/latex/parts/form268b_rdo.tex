...
\hline
\textbf{Burn ID} & \textbf{Name} & \textbf{Active} & \bfseries\makecell[c]{Further \\ Ignitions \\ Required} & \bfseries\makecell[c]{Achieved \\ Yesterday} & \textbf{Tenure} & \bfseries\makecell[c]{External \\ Assistance}\\
\hline
\endhead
...
%%\begin{longtabu} to \linewidth { | X | X | X | X |} %%X | X | X | }
\hline
\textbf{Burn ID} & \textbf{Name} & \textbf{Active} & \textbf{Area} & \textbf{Tenure} & \bfseries\makecell[c]{External \\ Assistance}\\
\hline
\endhead
{% for pb in qs_fireload_rdo %}
