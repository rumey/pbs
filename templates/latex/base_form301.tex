...
\usepackage[includeheadfoot,landscape, left=1.5cm,right=1.5cm,top=0cm,bottom=3cm]{geometry}
\usepackage{fancyhdr}
\usepackage{lastpage}
\usepackage{graphicx}
\usepackage{hyphenat}
...
\fancypagestyle{plain}{%
  ...
  {% block header %}
  %\fancyhead[L]{\href{http://www.dpaw.wa.gov.au}{\includegraphics[scale=0.6]{% templatetag openbrace %}{% base_dir %}/staticfiles/pbs/img/dpaw-daily-burns.png}}}
  \fancyhead[L]{\href{http://www.dpaw.wa.gov.au}{\includegraphics[scale=0.6]{% templatetag openbrace %}{% base_dir %}/pbs/static/pbs/img/dpaw-daily-burns.png}}}
  \fancyhead[R] {
