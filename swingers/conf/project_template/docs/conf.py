...
# sphinx-quickstart on Tue Jan 22 11:45:34 2013.
#
...
intersphinx_mapping = {
    ...
    'guardian': ('http://packages.python.org/django-guardian/', None)
}
...
texinfo_documents = [
  ('index', '{{ project_name }}', '{{ project_name }} Documentation',
   'DPaW', '{{ project_name }}', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_author = 'Department of Parks and Wildlife'
epub_publisher = 'Department of Parks and Wildlife'
epub_copyright = '2013, Department of Parks and Wildlife'
