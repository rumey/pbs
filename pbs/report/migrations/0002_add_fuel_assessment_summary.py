...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BurnImplementationState.fuel_assessment'
        db.add_column(u'report_burnimplementationstate', 'fuel_assessment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BurnImplementationState.fuel_assessment'
        db.delete_column(u'report_burnimplementationstate', 'fuel_assessment')
