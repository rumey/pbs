...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AreaAchievement.prescription'
        db.alter_column(u'report_areaachievement', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'PostBurnChecklist.prescription'
        db.alter_column(u'report_postburnchecklist', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], null=True, on_delete=models.PROTECT))

        # Changing field 'ProposedAction.prescription'
        db.alter_column(u'report_proposedaction', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'AreaAchievement.prescription'
        db.alter_column(u'report_areaachievement', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'PostBurnChecklist.prescription'
        db.alter_column(u'report_postburnchecklist', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], null=True))

        # Changing field 'ProposedAction.prescription'
        db.alter_column(u'report_proposedaction', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))
    ...
    models = {
        ...
        u'report.burnimplementationstate': {
            ...
            'fuel_assessment': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
