...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BurnImplementationState.fuel_assessment'
        db.alter_column(u'report_burnimplementationstate', 'fuel_assessment', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'BurnImplementationState.fuel_assessment'
        db.alter_column(u'report_burnimplementationstate', 'fuel_assessment', self.gf('django.db.models.fields.BooleanField')())
