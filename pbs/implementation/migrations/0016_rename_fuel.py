...
#	import ipdb; ipdb.set_trace()
        db.rename_column('implementation_burningprescription','fuel_type_new_id','fuel_type_id')
	db.rename_column('implementation_edgingplan','fuel_type_new_id','fuel_type_id')
    ...
    models = {
        ...
        u'implementation.burningprescription': {
            ...
            'fuel_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['prescription.VegetationType']", 'null': 'True', 'blank': 'True'}),
