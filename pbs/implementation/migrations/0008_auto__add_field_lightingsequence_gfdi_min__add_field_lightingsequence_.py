...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LightingSequence.gfdi_min'
        db.add_column(u'implementation_lightingsequence', 'gfdi_min',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LightingSequence.gfdi_max'
        db.add_column(u'implementation_lightingsequence', 'gfdi_max',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LightingSequence.grassland_curing_min'
        db.add_column(u'implementation_lightingsequence', 'grassland_curing_min',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LightingSequence.grassland_curing_max'
        db.add_column(u'implementation_lightingsequence', 'grassland_curing_max',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'BurningPrescription.glc_pct'
        db.delete_column(u'implementation_burningprescription', 'glc_pct')


    def backwards(self, orm):
        # Deleting field 'LightingSequence.gfdi_min'
        db.delete_column(u'implementation_lightingsequence', 'gfdi_min')

        # Deleting field 'LightingSequence.gfdi_max'
        db.delete_column(u'implementation_lightingsequence', 'gfdi_max')

        # Deleting field 'LightingSequence.grassland_curing_min'
        db.delete_column(u'implementation_lightingsequence', 'grassland_curing_min')

        # Deleting field 'LightingSequence.grassland_curing_max'
        db.delete_column(u'implementation_lightingsequence', 'grassland_curing_max')

        # Adding field 'BurningPrescription.glc_pct'
        db.add_column(u'implementation_burningprescription', 'glc_pct',
