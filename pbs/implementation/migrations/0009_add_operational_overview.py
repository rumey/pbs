...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OperationalOverview'
        db.create_table(u'implementation_operationaloverview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'implementation_operationaloverview_created', to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'implementation_operationaloverview_modified', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'implementation', ['OperationalOverview'])


    def backwards(self, orm):
        # Deleting model 'OperationalOverview'
        db.delete_table(u'implementation_operationaloverview')
