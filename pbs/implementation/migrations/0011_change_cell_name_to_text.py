...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LightingSequence.cellname'
        db.alter_column(u'implementation_lightingsequence', 'cellname', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'LightingSequence.cellname'
        db.alter_column(u'implementation_lightingsequence', 'cellname', self.gf('django.db.models.fields.CharField')(max_length=64))
