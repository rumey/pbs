...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EdgingPlan.fuel_type'
        db.alter_column(u'implementation_edgingplan', 'fuel_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.VegetationType'], null=True))

        # Changing field 'BurningPrescription.fuel_type'
        db.alter_column(u'implementation_burningprescription', 'fuel_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.VegetationType'], null=True))
