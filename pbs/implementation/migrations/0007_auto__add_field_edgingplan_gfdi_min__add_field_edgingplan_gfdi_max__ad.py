...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EdgingPlan.gfdi_min'
        db.add_column(u'implementation_edgingplan', 'gfdi_min',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EdgingPlan.gfdi_max'
        db.add_column(u'implementation_edgingplan', 'gfdi_max',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EdgingPlan.grassland_curing_min'
        db.add_column(u'implementation_edgingplan', 'grassland_curing_min',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EdgingPlan.grassland_curing_max'
        db.add_column(u'implementation_edgingplan', 'grassland_curing_max',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BurningPrescription.gfdi_min'
        db.add_column(u'implementation_burningprescription', 'gfdi_min',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BurningPrescription.gfdi_max'
        db.add_column(u'implementation_burningprescription', 'gfdi_max',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BurningPrescription.grassland_curing_min'
        db.add_column(u'implementation_burningprescription', 'grassland_curing_min',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BurningPrescription.grassland_curing_max'
        db.add_column(u'implementation_burningprescription', 'grassland_curing_max',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EdgingPlan.gfdi_min'
        db.delete_column(u'implementation_edgingplan', 'gfdi_min')

        # Deleting field 'EdgingPlan.gfdi_max'
        db.delete_column(u'implementation_edgingplan', 'gfdi_max')

        # Deleting field 'EdgingPlan.grassland_curing_min'
        db.delete_column(u'implementation_edgingplan', 'grassland_curing_min')

        # Deleting field 'EdgingPlan.grassland_curing_max'
        db.delete_column(u'implementation_edgingplan', 'grassland_curing_max')

        # Deleting field 'BurningPrescription.gfdi_min'
        db.delete_column(u'implementation_burningprescription', 'gfdi_min')

        # Deleting field 'BurningPrescription.gfdi_max'
        db.delete_column(u'implementation_burningprescription', 'gfdi_max')

        # Deleting field 'BurningPrescription.grassland_curing_min'
        db.delete_column(u'implementation_burningprescription', 'grassland_curing_min')

        # Deleting field 'BurningPrescription.grassland_curing_max'
        db.delete_column(u'implementation_burningprescription', 'grassland_curing_max')
    ...
    models = {
        ...
        u'implementation.lightingsequence': {
            'Meta': {'ordering': "[u'id']", 'unique_together': "((u'prescription', u'seqno'),)", 'object_name': 'LightingSequence'},
