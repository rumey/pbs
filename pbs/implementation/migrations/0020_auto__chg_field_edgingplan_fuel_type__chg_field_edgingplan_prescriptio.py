...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'implementation_edgingplan', 'fuel_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.FuelType'], null=True, on_delete=models.PROTECT))

        # Changing field 'EdgingPlan.prescription'
        db.alter_column(u'implementation_edgingplan', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'OperationalOverview.prescription'
        db.alter_column(u'implementation_operationaloverview', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'ExclusionArea.prescription'
        db.alter_column(u'implementation_exclusionarea', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'RoadSegment.traffic_diagram'
        db.alter_column(u'implementation_roadsegment', 'traffic_diagram_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['implementation.TrafficControlDiagram'], null=True, on_delete=models.PROTECT))

        # Changing field 'SignInspection.way'
        db.alter_column(u'implementation_signinspection', 'way_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['implementation.Way'], on_delete=models.PROTECT))

        # Changing field 'LightingSequence.prescription'
        db.alter_column(u'implementation_lightingsequence', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'Way.prescription'
        db.alter_column(u'implementation_way', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'BurningPrescription.fuel_type'
        db.alter_column(u'implementation_burningprescription', 'fuel_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.FuelType'], null=True, on_delete=models.PROTECT))

        # Changing field 'BurningPrescription.prescription'
        db.alter_column(u'implementation_burningprescription', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'EdgingPlan.fuel_type'
        db.alter_column(u'implementation_edgingplan', 'fuel_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.FuelType'], null=True))

        # Changing field 'EdgingPlan.prescription'
        db.alter_column(u'implementation_edgingplan', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'OperationalOverview.prescription'
        db.alter_column(u'implementation_operationaloverview', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'ExclusionArea.prescription'
        db.alter_column(u'implementation_exclusionarea', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'RoadSegment.traffic_diagram'
        db.alter_column(u'implementation_roadsegment', 'traffic_diagram_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['implementation.TrafficControlDiagram'], null=True))

        # Changing field 'SignInspection.way'
        db.alter_column(u'implementation_signinspection', 'way_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['implementation.Way']))

        # Changing field 'LightingSequence.prescription'
        db.alter_column(u'implementation_lightingsequence', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'Way.prescription'
        db.alter_column(u'implementation_way', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'BurningPrescription.fuel_type'
        db.alter_column(u'implementation_burningprescription', 'fuel_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.FuelType'], null=True))

        # Changing field 'BurningPrescription.prescription'
        db.alter_column(u'implementation_burningprescription', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))
