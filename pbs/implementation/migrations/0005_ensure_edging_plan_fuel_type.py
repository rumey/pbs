...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            default_type = orm['implementation.FuelType'].objects.get(pk=1)
        except orm['implementation.FuelType'].DoesNotExist:
            pass
        else:
            for plan in orm.EdgingPlan.objects.all():
                try:
                    fuel_type = plan.fuel_type
                except Exception:
                    plan.fuel_type = default_type
                    plan.save()
