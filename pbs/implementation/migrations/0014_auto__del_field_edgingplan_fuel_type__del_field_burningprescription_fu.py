...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EdgingPlan.fuel_type'
        db.delete_column(u'implementation_edgingplan', 'fuel_type_id')

        # Deleting field 'BurningPrescription.fuel_type'
        db.delete_column(u'implementation_burningprescription', 'fuel_type_id')


    def backwards(self, orm):
        # Adding field 'EdgingPlan.fuel_type'
        db.add_column(u'implementation_edgingplan', 'fuel_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['implementation.FuelType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'BurningPrescription.fuel_type'
        db.add_column(u'implementation_burningprescription', 'fuel_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['implementation.FuelType'], null=True, blank=True),
                      keep_default=False)
