...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'document_documentcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'document', ['DocumentCategory'])

        # Adding model 'DocumentTag'
        db.create_table(u'document_documenttag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['document.DocumentCategory'])),
        ))
        db.send_create_signal(u'document', ['DocumentTag'])

        # Adding model 'Document'
        db.create_table(u'document_document', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'document_document_created', to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'document_document_modified', to=orm['auth.User'])),
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'documents', to=orm['document.DocumentCategory'])),
            ('tag', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['document.DocumentTag'])),
            ('custom_tag', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('document', self.gf('pbs.document.models.ContentTypeRestrictedFileField')(max_length=200)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'document_documentcategory')

        # Deleting model 'DocumentTag'
        db.delete_table(u'document_documenttag')
    ...
    models = {
        ...
        u'document.document': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'documents'", 'to': u"orm['document.DocumentCategory']"}),
            ...
            'document': ('pbs.document.models.ContentTypeRestrictedFileField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'tag': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': u"orm['document.DocumentTag']"})
        },
        ...
        u'document.documenttag': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['document.DocumentCategory']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
