...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.document_created'
        #db.add_column(u'document_document', 'document_created', self.gf('django.db.models.fields.DateTimeField')(default=''), keep_default=False)
        db.add_column(u'document_document', 'document_created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Document_document.document_created'
        db.delete_column(u'document_document', 'document_created')
    ...
    models = {
        ...
        u'document.document': {
            ...
            'document_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
