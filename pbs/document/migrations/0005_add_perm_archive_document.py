...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(
            model='document', app_label='document',name="document")
        perm, created = orm['auth.permission'].objects.get_or_create(
            content_type=ct, codename='archive_document', defaults=dict(name=u'Can archive documents'))
    ...
    complete_apps = ['contenttypes', 'auth', 'document']
    symmetrical = True
