...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.document_archive'
        db.add_column(u'document_document', 'document_archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Document_document.document_archive'
        db.delete_column(u'document_document', 'document_archived')
