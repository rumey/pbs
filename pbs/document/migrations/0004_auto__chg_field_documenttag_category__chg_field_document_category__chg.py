...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocumentTag.category'
        db.alter_column(u'document_documenttag', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['document.DocumentCategory'], on_delete=models.PROTECT))

        # Changing field 'Document.category'
        db.alter_column(u'document_document', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['document.DocumentCategory']))

        # Changing field 'Document.prescription'
        db.alter_column(u'document_document', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], null=True, on_delete=models.PROTECT))

        # Changing field 'Document.document_created'
        db.alter_column(u'document_document', 'document_created', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Document.tag'
        db.alter_column(u'document_document', 'tag_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['document.DocumentTag'], on_delete=models.PROTECT))

        # Changing field 'Document.document'
        db.alter_column(u'document_document', 'document', self.gf('pbs.document.fields.ContentTypeRestrictedFileField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'DocumentTag.category'
        db.alter_column(u'document_documenttag', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['document.DocumentCategory']))

        # Changing field 'Document.category'
        db.alter_column(u'document_document', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['document.DocumentCategory']))

        # Changing field 'Document.prescription'
        db.alter_column(u'document_document', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], null=True))

        # Changing field 'Document.document_created'
        db.alter_column(u'document_document', 'document_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Document.tag'
        db.alter_column(u'document_document', 'tag_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['document.DocumentTag']))

        # Changing field 'Document.document'
        db.alter_column(u'document_document', 'document', self.gf('pbs.document.models.ContentTypeRestrictedFileField')(max_length=200))
    ...
    models = {
        ...
        u'document.document': {
            'Meta': {'ordering': "[u'tag', u'document']", 'object_name': 'Document'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'documents'", 'on_delete': 'models.PROTECT', 'to': u"orm['document.DocumentCategory']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'document_document_created'", 'to': u"orm['auth.User']"}),
            'custom_tag': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            'document': ('pbs.document.fields.ContentTypeRestrictedFileField', [], {'max_length': '200'}),
            'document_archived': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'document_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'document_document_modified'", 'to': u"orm['auth.User']"}),
            ...
            'tag': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': u"orm['document.DocumentTag']", 'on_delete': 'models.PROTECT'})
        },
        u'document.documentcategory': {
            'Meta': {'ordering': "[u'name']", 'object_name': 'DocumentCategory'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'order': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'})
        },
        u'document.documenttag': {
            'Meta': {'ordering': "[u'name']", 'object_name': 'DocumentTag'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['document.DocumentCategory']", 'on_delete': 'models.PROTECT'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
