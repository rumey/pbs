...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContingencyNotification.contingency'
        db.alter_column(u'risk_contingencynotification', 'contingency_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['risk.Contingency']))

        # Changing field 'Context.prescription'
        db.alter_column(u'risk_context', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'Risk.category'
        db.alter_column(u'risk_risk', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.RiskCategory'], on_delete=models.PROTECT))

        # Changing field 'Risk.prescription'
        db.alter_column(u'risk_risk', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], null=True, on_delete=models.PROTECT))

        # Changing field 'ContingencyAction.contingency'
        db.alter_column(u'risk_contingencyaction', 'contingency_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['risk.Contingency']))

        # Changing field 'Complexity.prescription'
        db.alter_column(u'risk_complexity', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], null=True, on_delete=models.PROTECT))

        # Changing field 'Contingency.prescription'
        db.alter_column(u'risk_contingency', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'Register.prescription'
        db.alter_column(u'risk_register', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'Action.risk'
        db.alter_column(u'risk_action', 'risk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.Risk'], on_delete=models.PROTECT))

        # Changing field 'Treatment.register'
        db.alter_column(u'risk_treatment', 'register_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.Register'], on_delete=models.PROTECT))

        # Changing field 'Treatment.location'
        db.alter_column(u'risk_treatment', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.TreatmentLocation'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'ContingencyNotification.contingency'
        db.alter_column(u'risk_contingencynotification', 'contingency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.Contingency']))

        # Changing field 'Context.prescription'
        db.alter_column(u'risk_context', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'Risk.category'
        db.alter_column(u'risk_risk', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.RiskCategory']))

        # Changing field 'Risk.prescription'
        db.alter_column(u'risk_risk', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], null=True))

        # Changing field 'ContingencyAction.contingency'
        db.alter_column(u'risk_contingencyaction', 'contingency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.Contingency']))

        # Changing field 'Complexity.prescription'
        db.alter_column(u'risk_complexity', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], null=True))

        # Changing field 'Contingency.prescription'
        db.alter_column(u'risk_contingency', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'Register.prescription'
        db.alter_column(u'risk_register', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'Action.risk'
        db.alter_column(u'risk_action', 'risk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.Risk']))

        # Changing field 'Treatment.register'
        db.alter_column(u'risk_treatment', 'register_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.Register']))

        # Changing field 'Treatment.location'
        db.alter_column(u'risk_treatment', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.TreatmentLocation']))
    ...
    models = {
        ...
        u'risk.contingency': {
            ...
            'actions_migrated': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'notifications_migrated': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'risk.contingencyaction': {
            'Meta': {'object_name': 'ContingencyAction'},
            'action': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'contingency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'actions'", 'on_delete': 'models.PROTECT', 'to': u"orm['risk.Contingency']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'risk_contingencyaction_created'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'risk_contingencyaction_modified'", 'to': u"orm['auth.User']"})
        },
        u'risk.contingencynotification': {
            'Meta': {'ordering': "[u'name']", 'object_name': 'ContingencyNotification'},
            'contact_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'contingency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'notifications'", 'on_delete': 'models.PROTECT', 'to': u"orm['risk.Contingency']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'risk_contingencynotification_created'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'risk_contingencynotification_modified'", 'to': u"orm['auth.User']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'organisation': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        u'risk.register': {
        ...
        u'risk.treatment': {
            ...
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['risk.TreatmentLocation']", 'on_delete': 'models.PROTECT'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'risk_treatment_modified'", 'to': u"orm['auth.User']"}),
            'register': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['risk.Register']", 'on_delete': 'models.PROTECT'})
        },
