...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for prescription in orm['prescription.Prescription'].objects.all():
            contexts = list(orm.Context.objects.filter(prescription=prescription))
            statement = '\n\n'.join(c.statement for c in contexts)
            chosen_one = contexts.pop()
            chosen_one.statement = statement
            chosen_one.save()
