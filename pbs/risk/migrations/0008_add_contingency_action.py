...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContingencyAction'
        db.create_table(u'risk_contingencyaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'risk_contingencyaction_created', to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'risk_contingencyaction_modified', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('contingency', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'actions', to=orm['risk.Contingency'])),
            ('details', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'risk', ['ContingencyAction'])


    def backwards(self, orm):
        # Deleting model 'ContingencyAction'
        db.delete_table(u'risk_contingencyaction')
