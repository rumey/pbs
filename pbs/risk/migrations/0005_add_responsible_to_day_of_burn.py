...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.day_of_burn_responsible'
        db.add_column(u'risk_action', 'day_of_burn_responsible',
                      self.gf('django.db.models.fields.CharField')(default=u'IC', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.day_of_burn_responsible'
        db.delete_column(u'risk_action', 'day_of_burn_responsible')
