...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ContingencyNotification', fields ['contingency']
        db.delete_unique(u'risk_contingencynotification', ['contingency_id'])


        # Changing field 'ContingencyNotification.contact_number'
        db.alter_column(u'risk_contingencynotification', 'contact_number', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'ContingencyNotification.name'
        db.alter_column(u'risk_contingencynotification', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'ContingencyNotification.organisation'
        db.alter_column(u'risk_contingencynotification', 'organisation', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'ContingencyNotification.location'
        db.alter_column(u'risk_contingencynotification', 'location', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ContingencyNotification.contact_number'
        db.alter_column(u'risk_contingencynotification', 'contact_number', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ContingencyNotification.name'
        db.alter_column(u'risk_contingencynotification', 'name', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ContingencyNotification.organisation'
        db.alter_column(u'risk_contingencynotification', 'organisation', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ContingencyNotification.location'
        db.alter_column(u'risk_contingencynotification', 'location', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ContingencyNotification.contingency'
        db.alter_column(u'risk_contingencynotification', 'contingency_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['risk.Contingency'], unique=True))
        # Adding unique constraint on 'ContingencyNotification', fields ['contingency']
        db.create_unique(u'risk_contingencynotification', ['contingency_id'])
    ...
    models = {
        ...
        u'risk.contingencynotification': {
            ...
            'contingency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'notifications'", 'to': u"orm['risk.Contingency']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
