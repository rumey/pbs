...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contingency.action'
        db.alter_column(u'risk_contingency', 'action', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Contingency.action'
        raise RuntimeError("Cannot reverse this migration. 'Contingency.action' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Contingency.action'
        db.alter_column(u'risk_contingency', 'action', self.gf('django.db.models.fields.TextField')())
