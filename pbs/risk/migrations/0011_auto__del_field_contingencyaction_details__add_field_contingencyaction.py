...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'ContingencyAction.details'
        db.rename_column(u'risk_contingencyaction', 'details', 'action')

        # Adding field 'Contingency.actions_migrated'
        db.add_column(u'risk_contingency', 'actions_migrated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Contingency.notifications_migrated'
        db.add_column(u'risk_contingency', 'notifications_migrated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Renaming field 'ContingencyAction.action'
        db.rename_column(u'risk_contingencyaction', 'action', 'details')

        # Deleting field 'Contingency.actions_migrated'
        db.delete_column(u'risk_contingency', 'actions_migrated')

        # Deleting field 'Contingency.notifications_migrated'
        db.delete_column(u'risk_contingency', 'notifications_migrated')
    ...
    models = {
        ...
        u'risk.contingency': {
            ...
            'actions_migrated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'notifications_migrated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'risk.contingencyaction': {
            ...
            'action': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'contingency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'actions'", 'to': u"orm['risk.Contingency']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
