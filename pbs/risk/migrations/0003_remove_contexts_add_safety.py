...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Context.category'
        db.delete_column(u'risk_context', 'category')

        # Adding field 'Action.day_of_burn_safety'
        db.add_column(u'risk_action', 'day_of_burn_safety',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Context.category'
        raise RuntimeError("Cannot reverse this migration. 'Context.category' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Context.category'
        db.add_column(u'risk_context', 'category',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(),
                      keep_default=False)

        # Deleting field 'Action.day_of_burn_safety'
        db.delete_column(u'risk_action', 'day_of_burn_safety')
