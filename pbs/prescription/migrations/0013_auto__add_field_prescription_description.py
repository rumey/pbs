...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prescription.description'
        db.add_column(u'prescription_prescription', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prescription.description'
        db.delete_column(u'prescription_prescription', 'description')
