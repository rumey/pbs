...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prescription.financial_year'
        db.add_column(u'prescription_prescription', 'financial_year',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=10),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Prescription.financial_year'
        db.delete_column(u'prescription_prescription', 'financial_year')
