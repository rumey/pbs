...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EndorsingRole.index'
        db.add_column(u'prescription_endorsingrole', 'index',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EndorsingRole.index'
        db.delete_column(u'prescription_endorsingrole', 'index')
