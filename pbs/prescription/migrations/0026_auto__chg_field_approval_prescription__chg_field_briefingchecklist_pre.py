...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Approval.prescription'
        db.alter_column(u'prescription_approval', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'BriefingChecklist.prescription'
        db.alter_column(u'prescription_briefingchecklist', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'BriefingChecklist.smeac'
        db.alter_column(u'prescription_briefingchecklist', 'smeac_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.SMEAC'], on_delete=models.PROTECT))

        # Changing field 'BriefingChecklist.action'
        db.alter_column(u'prescription_briefingchecklist', 'action_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.Action'], null=True, on_delete=models.PROTECT))

        # Changing field 'RegionalObjective.region'
        db.alter_column(u'prescription_regionalobjective', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Region'], on_delete=models.PROTECT))

        # Changing field 'DefaultBriefingChecklist.smeac'
        db.alter_column(u'prescription_defaultbriefingchecklist', 'smeac_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.SMEAC'], on_delete=models.PROTECT))

        # Changing field 'PriorityJustification.prescription'
        db.alter_column(u'prescription_priorityjustification', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], null=True, on_delete=models.PROTECT))

        # Changing field 'PriorityJustification.purpose'
        db.alter_column(u'prescription_priorityjustification', 'purpose_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Purpose'], on_delete=models.PROTECT))

        # Changing field 'Objective.prescription'
        db.alter_column(u'prescription_objective', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'Endorsement.prescription'
        db.alter_column(u'prescription_endorsement', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'Endorsement.role'
        db.alter_column(u'prescription_endorsement', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.EndorsingRole'], on_delete=models.PROTECT))

        # Changing field 'FundingAllocation.prescription'
        db.alter_column(u'prescription_fundingallocation', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'Prescription.closure_officer'
        db.alter_column(u'prescription_prescription', 'closure_officer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['auth.User']))

        # Changing field 'Prescription.district'
        db.alter_column(u'prescription_prescription', 'district_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['prescription.District'], null=True, on_delete=models.PROTECT))

        # Changing field 'Prescription.prescribing_officer'
        db.alter_column(u'prescription_prescription', 'prescribing_officer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Prescription.region'
        db.alter_column(u'prescription_prescription', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Region'], on_delete=models.PROTECT))

        # Changing field 'SuccessCriteria.prescription'
        db.alter_column(u'prescription_successcriteria', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'Shire.district'
        db.alter_column(u'prescription_shire', 'district_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.District'], on_delete=models.PROTECT))

        # Changing field 'District.region'
        db.alter_column(u'prescription_district', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Region'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Approval.prescription'
        db.alter_column(u'prescription_approval', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'BriefingChecklist.prescription'
        db.alter_column(u'prescription_briefingchecklist', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'BriefingChecklist.smeac'
        db.alter_column(u'prescription_briefingchecklist', 'smeac_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.SMEAC']))

        # Changing field 'BriefingChecklist.action'
        db.alter_column(u'prescription_briefingchecklist', 'action_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.Action'], null=True))

        # Changing field 'RegionalObjective.region'
        db.alter_column(u'prescription_regionalobjective', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Region']))

        # Changing field 'DefaultBriefingChecklist.smeac'
        db.alter_column(u'prescription_defaultbriefingchecklist', 'smeac_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.SMEAC']))

        # Changing field 'PriorityJustification.prescription'
        db.alter_column(u'prescription_priorityjustification', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], null=True))

        # Changing field 'PriorityJustification.purpose'
        db.alter_column(u'prescription_priorityjustification', 'purpose_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Purpose']))

        # Changing field 'Objective.prescription'
        db.alter_column(u'prescription_objective', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'Endorsement.prescription'
        db.alter_column(u'prescription_endorsement', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'Endorsement.role'
        db.alter_column(u'prescription_endorsement', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.EndorsingRole']))

        # Changing field 'FundingAllocation.prescription'
        db.alter_column(u'prescription_fundingallocation', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'Prescription.closure_officer'
        db.alter_column(u'prescription_prescription', 'closure_officer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Prescription.district'
        db.alter_column(u'prescription_prescription', 'district_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['prescription.District'], null=True))

        # Changing field 'Prescription.prescribing_officer'
        db.alter_column(u'prescription_prescription', 'prescribing_officer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Prescription.region'
        db.alter_column(u'prescription_prescription', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Region']))

        # Changing field 'SuccessCriteria.prescription'
        db.alter_column(u'prescription_successcriteria', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'Shire.district'
        db.alter_column(u'prescription_shire', 'district_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.District']))

        # Changing field 'District.region'
        db.alter_column(u'prescription_district', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Region']))
    ...
    models = {
        ...
        u'prescription.approval': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial_valid_to': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2018, 6, 16, 0, 0)'}),
