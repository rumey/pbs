...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prescription.closure_officer'
        db.add_column(u'prescription_prescription', 'closure_officer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'closure', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prescription.closure_officer'
        db.delete_column(u'prescription_prescription', 'closure_officer_id')
