...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FundingAllocation.allocation'
        db.alter_column(u'prescription_fundingallocation', 'allocation', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=42, max_length=64))

        # Changing field 'Prescription.planned_season'
        db.alter_column(u'prescription_prescription', 'planned_season', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=64, null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'FundingAllocation', fields ['prescription', 'allocation']
        db.delete_unique(u'prescription_fundingallocation', ['prescription_id', 'allocation'])


        # Changing field 'FundingAllocation.allocation'
        db.alter_column(u'prescription_fundingallocation', 'allocation', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=64, null=True))

        # User chose to not deal with backwards NULL issues for 'Prescription.planned_season'
        raise RuntimeError("Cannot reverse this migration. 'Prescription.planned_season' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Prescription.planned_season'
        db.alter_column(u'prescription_prescription', 'planned_season', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=64))
