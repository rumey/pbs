...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Prescription.allocation'
        db.delete_column(u'prescription_prescription', 'allocation')


    def backwards(self, orm):
        # Adding field 'Prescription.allocation'
        db.add_column(u'prescription_prescription', 'allocation',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=64, null=True, blank=True),
                      keep_default=False)
