...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Purpose.display_order'
        db.add_column(u'prescription_purpose', 'display_order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Purpose.display_order'
        db.delete_column(u'prescription_purpose', 'display_order')
    ...
    models = {
        ...
        u'prescription.approval': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial_valid_to': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2017, 9, 8, 0, 0)'}),
