...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field fuel_types on 'Prescription'
        m2m_table_name = db.shorten_name(u'prescription_prescription_fuel_types')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('prescription', models.ForeignKey(orm[u'prescription.prescription'], null=False)),
            ('fueltype', models.ForeignKey(orm[u'prescription.fueltype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['prescription_id', 'fueltype_id'])
	db.execute('INSERT INTO prescription_fueltype SELECT * FROM prescription_vegetationtype')
	db.execute('INSERT INTO prescription_prescription_fuel_types SELECT * FROM prescription_prescription_vegetation_types')


    def backwards(self, orm):
        # Removing M2M table for field fuel_types on 'Prescription'
        db.delete_table(db.shorten_name(u'prescription_prescription_fuel_types'))
