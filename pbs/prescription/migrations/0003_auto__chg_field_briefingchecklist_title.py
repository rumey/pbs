...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BriefingChecklist.title'
        db.alter_column(u'prescription_briefingchecklist', 'title', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BriefingChecklist.title'
        db.alter_column(u'prescription_briefingchecklist', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))
