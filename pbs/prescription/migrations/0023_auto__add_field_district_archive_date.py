...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'District.archive_date'
        db.add_column(u'prescription_district', 'archive_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'District.archive_date'
        db.delete_column(u'prescription_district', 'archive_date')
