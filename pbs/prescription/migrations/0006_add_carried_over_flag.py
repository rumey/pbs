...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prescription.carried_over'
        db.add_column(u'prescription_prescription', 'carried_over',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prescription.carried_over'
        db.delete_column(u'prescription_prescription', 'carried_over')
