...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field critical_stakeholders on 'Prescription'
        db.create_table(u'prescription_prescription_critical_stakeholders', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('prescription', models.ForeignKey(orm[u'prescription.prescription'], null=False)),
            ('criticalstakeholder', models.ForeignKey(orm[u'stakeholder.criticalstakeholder'], null=False))
        ))
        db.create_unique(u'prescription_prescription_critical_stakeholders', ['prescription_id', 'criticalstakeholder_id'])

        db.add_column('prescription_prescription', 'action', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['risk.Action'], null=True, blank=True)),

        # Deleting field 'Prescription.biodiversity_text_additional'
        db.delete_column(u'prescription_prescription', 'biodiversity_text_additional')

        # Deleting field 'Prescription.biodiversity_text'
        db.delete_column(u'prescription_prescription', 'biodiversity_text')

        # Deleting field 'Prescription.vegetation_text'
        db.delete_column(u'prescription_prescription', 'vegetation_text')

        # Deleting field 'Prescription.bushfire_risk_text'
        db.delete_column(u'prescription_prescription', 'bushfire_risk_text')


    def backwards(self, orm):
        # Adding field 'Prescription.biodiversity_text_additional'
        db.add_column(u'prescription_prescription', 'biodiversity_text_additional',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Prescription.biodiversity_text'
        db.add_column(u'prescription_prescription', 'biodiversity_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Prescription.vegetation_text'
        db.add_column(u'prescription_prescription', 'vegetation_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Prescription.bushfire_risk_text'
        db.add_column(u'prescription_prescription', 'bushfire_risk_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
