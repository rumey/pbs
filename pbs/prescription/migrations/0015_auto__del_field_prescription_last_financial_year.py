...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Prescription.last_season'
        db.alter_column(u'prescription_prescription', 'last_season', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True))

        # Changing field 'Prescription.last_year'
        db.alter_column(u'prescription_prescription', 'last_year', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True))

    def backwards(self, orm):
        # Changing field 'Prescription.last_season'
        db.alter_column(u'prescription_prescription', 'last_season', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=64, null=True))

        # Changing field 'Prescription.last_year'
        db.alter_column(u'prescription_prescription', 'last_year', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=64, null=True))
