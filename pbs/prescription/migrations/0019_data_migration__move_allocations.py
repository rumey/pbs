...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for p in orm.Prescription.objects.all():
            ...
            if allocation is not None:  # Only transfer complete records
                proportion = 100.0
                a = orm.FundingAllocation(
                    prescription=p, allocation=allocation, proportion=proportion)
                a.save()
    ...
    def backwards(self, orm):
        ...
        for p in orm.Prescription.objects.all():
            try:
                a = orm.FundingAllocation.objects.get(prescription=p)
