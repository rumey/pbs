...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EndorsingRole.archived'
        db.add_column(u'prescription_endorsingrole', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EndorsingRole.archived'
        db.delete_column(u'prescription_endorsingrole', 'archived')
    ...
    models = {
        ...
        u'prescription.approval': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial_valid_to': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2019, 4, 5, 0, 0)'}),
