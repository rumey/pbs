...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prescription.contingencies_migrated'
        db.add_column(u'prescription_prescription', 'contingencies_migrated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prescription.contingencies_migrated'
        db.delete_column(u'prescription_prescription', 'contingencies_migrated')
