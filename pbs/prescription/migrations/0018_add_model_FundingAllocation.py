...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FundingAllocation'
        db.create_table(u'prescription_fundingallocation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prescription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'])),
            ('allocation', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=64)),
            ('proportion', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2, default=0)),
        ))
        # Adding unique constraint on 'FundingAllocation', fields ['prescription', 'allocation']
        db.create_unique(u'prescription_fundingallocation', ['prescription_id', 'allocation'])

    def backwards(self, orm):
        # Deleting model 'FundingAllocation'
        ...
        db.delete_table(u'prescription_fundingallocation')
    ...
    models = {
        ...
        u'prescription.fundingallocation': {
            'Meta': {'object_name': 'FundingAllocation'},
            'allocation': ('django.db.models.fields.PositiveSmallIntegerField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prescription': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['prescription.Prescription']"}),
            'proportion': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '7'})
        },
