...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PrescribedBurn.submitted_date'
        db.delete_column(u'review_prescribedburn', 'submitted_date')

        # Deleting field 'PrescribedBurn.submitted_by'
        db.delete_column(u'review_prescribedburn', 'submitted_by_id')

        # Deleting field 'PrescribedBurn.approval_status'
        db.delete_column(u'review_prescribedburn', 'approval_status')

        # Deleting field 'PrescribedBurn.approved_date'
        db.delete_column(u'review_prescribedburn', 'approved_date')

        # Deleting field 'PrescribedBurn.endorsed_by'
        db.delete_column(u'review_prescribedburn', 'endorsed_by_id')

        # Deleting field 'PrescribedBurn.approved_by'
        db.delete_column(u'review_prescribedburn', 'approved_by_id')

        # Deleting field 'PrescribedBurn.approval_status_modified'
        db.delete_column(u'review_prescribedburn', 'approval_status_modified')

        # Deleting field 'PrescribedBurn.endorsed_date'
        db.delete_column(u'review_prescribedburn', 'endorsed_date')

        # Adding field 'PrescribedBurn.approval_268a_status'
        db.add_column(u'review_prescribedburn', 'approval_268a_status',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'PrescribedBurn.approval_268a_status_modified'
        db.add_column(u'review_prescribedburn', 'approval_268a_status_modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PrescribedBurn.approval_268b_status'
        db.add_column(u'review_prescribedburn', 'approval_268b_status',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'PrescribedBurn.approval_268b_status_modified'
        db.add_column(u'review_prescribedburn', 'approval_268b_status_modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PrescribedBurn.submitted_date'
        db.add_column(u'review_prescribedburn', 'submitted_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PrescribedBurn.submitted_by'
        db.add_column(u'review_prescribedburn', 'submitted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='submitted_by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Adding field 'PrescribedBurn.approval_status'
        db.add_column(u'review_prescribedburn', 'approval_status',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'PrescribedBurn.approved_date'
        db.add_column(u'review_prescribedburn', 'approved_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PrescribedBurn.endorsed_by'
        db.add_column(u'review_prescribedburn', 'endorsed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='endorsed_by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Adding field 'PrescribedBurn.approved_by'
        db.add_column(u'review_prescribedburn', 'approved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='approved_by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Adding field 'PrescribedBurn.approval_status_modified'
        db.add_column(u'review_prescribedburn', 'approval_status_modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PrescribedBurn.endorsed_date'
        db.add_column(u'review_prescribedburn', 'endorsed_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'PrescribedBurn.approval_268a_status'
        db.delete_column(u'review_prescribedburn', 'approval_268a_status')

        # Deleting field 'PrescribedBurn.approval_268a_status_modified'
        db.delete_column(u'review_prescribedburn', 'approval_268a_status_modified')

        # Deleting field 'PrescribedBurn.approval_268b_status'
        db.delete_column(u'review_prescribedburn', 'approval_268b_status')

        # Deleting field 'PrescribedBurn.approval_268b_status_modified'
        db.delete_column(u'review_prescribedburn', 'approval_268b_status_modified')
    ...
    models = {
        ...
        u'review.prescribedburn': {
            ...
            'approval_268a_status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'approval_268a_status_modified': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'approval_268b_status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'approval_268b_status_modified': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'further_ignitions': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
