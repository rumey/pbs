...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PrescribedBurn.fire_id'
        db.alter_column(u'review_prescribedburn', 'fire_id', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    models = {
        ...
        u'review.prescribedburn': {
            ...
            'completed': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'external_assist': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['review.ExternalAssist']", 'max_length': '25', 'blank': 'True'}),
