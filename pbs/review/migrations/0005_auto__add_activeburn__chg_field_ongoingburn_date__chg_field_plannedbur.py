...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActiveBurn'
        db.create_table(u'review_activeburn', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prescription', self.gf('django.db.models.fields.related.ForeignKey')(related_name='active_burn', to=orm['prescription.Prescription'])),
        ))
        db.send_create_signal(u'review', ['ActiveBurn'])


        # Changing field 'OngoingBurn.date'
        db.alter_column(u'review_ongoingburn', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'PlannedBurn.date'
        db.alter_column(u'review_plannedburn', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'ActiveBurn'
        db.delete_table(u'review_activeburn')


        # Changing field 'OngoingBurn.date'
        db.alter_column(u'review_ongoingburn', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'PlannedBurn.date'
        db.alter_column(u'review_plannedburn', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'review.activeburn': {
            'Meta': {'object_name': 'ActiveBurn'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prescription': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'active_burn'", 'to': u"orm['prescription.Prescription']"})
        },
        u'review.burnstate': {
        ...
        u'review.ongoingburn': {
            'Meta': {'object_name': 'OngoingBurn'},
            'burn_active': ('django.db.models.fields.BooleanField', [], {}),
            ...
            'ignition_type': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'prescription': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ongoing_burn'", 'to': u"orm['prescription.Prescription']"}),
            'tenure': ('django.db.models.fields.CharField', [], {'max_length': '24', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'review.plannedburn': {
            'Meta': {'object_name': 'PlannedBurn'},
            'area': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '7', 'decimal_places': '1'}),
            'conditions': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'est_start': ('django.db.models.fields.TimeField', [], {}),
            'has_contigency': ('django.db.models.fields.BooleanField', [], {}),
            'has_monitoring': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
