...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OngoingBurn.external_assist'
        db.delete_column(u'review_ongoingburn', 'external_assist')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'OngoingBurn.external_assist'
        raise RuntimeError("Cannot reverse this migration. 'OngoingBurn.external_assist' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'OngoingBurn.external_assist'
        db.add_column(u'review_ongoingburn', 'external_assist',
