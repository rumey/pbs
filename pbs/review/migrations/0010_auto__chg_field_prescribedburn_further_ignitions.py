...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PrescribedBurn.further_ignitions'
        db.alter_column(u'review_prescribedburn', 'further_ignitions', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PrescribedBurn.further_ignitions'
        raise RuntimeError("Cannot reverse this migration. 'PrescribedBurn.further_ignitions' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PrescribedBurn.further_ignitions'
        db.alter_column(u'review_prescribedburn', 'further_ignitions', self.gf('django.db.models.fields.BooleanField')())
