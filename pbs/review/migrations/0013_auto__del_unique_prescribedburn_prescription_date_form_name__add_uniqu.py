...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PrescribedBurn', fields ['prescription', 'fire_id', 'date', 'form_name']
        db.create_unique(u'review_prescribedburn', ['prescription_id', 'fire_id', 'date', 'form_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'PrescribedBurn', fields ['prescription', 'fire_id', 'date', 'form_name']
        db.delete_unique(u'review_prescribedburn', ['prescription_id', 'fire_id', 'date', 'form_name'])
    ...
    models = {
        ...
        u'review.prescribedburn': {
            'Meta': {'unique_together': "(('prescription', 'fire_id', 'date', 'form_name'),)", 'object_name': 'PrescribedBurn'},
            'approval_status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'approval_status_modified': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
