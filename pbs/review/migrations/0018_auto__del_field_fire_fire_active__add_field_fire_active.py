...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Fire.fire_active'
        db.delete_column(u'review_fire', 'fire_active')

        # Adding field 'Fire.active'
        db.add_column(u'review_fire', 'active',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Fire.fire_active'
        raise RuntimeError("Cannot reverse this migration. 'Fire.fire_active' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Fire.fire_active'
        db.add_column(u'review_fire', 'fire_active',
                      self.gf('django.db.models.fields.BooleanField')(),
                      keep_default=False)

        # Deleting field 'Fire.active'
        db.delete_column(u'review_fire', 'active')
