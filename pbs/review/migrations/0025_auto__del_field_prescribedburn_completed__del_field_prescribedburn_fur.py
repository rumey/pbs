...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PrescribedBurn.completed'
        db.delete_column(u'review_prescribedburn', 'completed')

        # Deleting field 'PrescribedBurn.further_ignitions'
        db.delete_column(u'review_prescribedburn', 'further_ignitions')

        # Adding field 'PrescribedBurn.ignition_status'
        db.add_column(u'review_prescribedburn', 'ignition_status',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PrescribedBurn.completed'
        db.add_column(u'review_prescribedburn', 'completed',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PrescribedBurn.further_ignitions'
        db.add_column(u'review_prescribedburn', 'further_ignitions',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PrescribedBurn.ignition_status'
        db.delete_column(u'review_prescribedburn', 'ignition_status')
