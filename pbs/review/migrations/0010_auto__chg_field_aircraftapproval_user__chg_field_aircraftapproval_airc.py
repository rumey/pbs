...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AircraftApproval.user'
        db.alter_column(u'review_aircraftapproval', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'AircraftApproval.aircraft_burn'
        db.alter_column(u'review_aircraftapproval', 'aircraft_burn_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['review.AircraftBurn']))

        # Changing field 'PrescribedBurn.district'
        db.alter_column(u'review_prescribedburn', 'district_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['prescription.District'], null=True, on_delete=models.PROTECT))

        # Changing field 'PrescribedBurn.prescription'
        db.alter_column(u'review_prescribedburn', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['prescription.Prescription']))

        # Changing field 'AircraftBurn.prescription'
        db.alter_column(u'review_aircraftburn', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['prescription.Prescription']))

        # Changing field 'BurnState.prescription'
        db.alter_column(u'review_burnstate', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['prescription.Prescription']))

        # Changing field 'BurnState.user'
        db.alter_column(u'review_burnstate', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.PROTECT))

        # Changing field 'Acknowledgement.user'
        db.alter_column(u'review_acknowledgement', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

        # Changing field 'Acknowledgement.burn'
        db.alter_column(u'review_acknowledgement', 'burn_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['review.PrescribedBurn']))

    def backwards(self, orm):

        # Changing field 'AircraftApproval.user'
        db.alter_column(u'review_aircraftapproval', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'AircraftApproval.aircraft_burn'
        db.alter_column(u'review_aircraftapproval', 'aircraft_burn_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.AircraftBurn']))

        # Changing field 'PrescribedBurn.district'
        db.alter_column(u'review_prescribedburn', 'district_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['prescription.District'], null=True))

        # Changing field 'PrescribedBurn.prescription'
        db.alter_column(u'review_prescribedburn', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['prescription.Prescription']))

        # Changing field 'AircraftBurn.prescription'
        db.alter_column(u'review_aircraftburn', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['prescription.Prescription']))

        # Changing field 'BurnState.prescription'
        db.alter_column(u'review_burnstate', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'BurnState.user'
        db.alter_column(u'review_burnstate', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Acknowledgement.user'
        db.alter_column(u'review_acknowledgement', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Acknowledgement.burn'
        db.alter_column(u'review_acknowledgement', 'burn_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.PrescribedBurn']))
    ...
    models = {
        ...
        u'review.annualindicativeburnprogram': {
            ...
            'fin_yr': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True', 'blank': 'True'}),
