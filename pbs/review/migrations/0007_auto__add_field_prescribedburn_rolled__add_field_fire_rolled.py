...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PrescribedBurn.rolled'
        db.add_column(u'review_prescribedburn', 'rolled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Fire.rolled'
        db.add_column(u'review_fire', 'rolled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PrescribedBurn.rolled'
        db.delete_column(u'review_prescribedburn', 'rolled')

        # Deleting field 'Fire.rolled'
        db.delete_column(u'review_fire', 'rolled')
