...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AnnualIndicativeBurnProgram.finan_yr'
        db.delete_column(u'review_annualindicativeburnprogram', 'finan_yr')

        # Adding field 'AnnualIndicativeBurnProgram.fin_yr'
        db.add_column(u'review_annualindicativeburnprogram', 'fin_yr',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AnnualIndicativeBurnProgram.finan_yr'
        db.add_column(u'review_annualindicativeburnprogram', 'finan_yr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Deleting field 'AnnualIndicativeBurnProgram.fin_yr'
        db.delete_column(u'review_annualindicativeburnprogram', 'fin_yr')
