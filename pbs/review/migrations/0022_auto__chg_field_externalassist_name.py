...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExternalAssist.name'
        db.alter_column(u'review_externalassist', 'name', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'ExternalAssist.name'
        db.alter_column(u'review_externalassist', 'name', self.gf('django.db.models.fields.CharField')(max_length=12))
