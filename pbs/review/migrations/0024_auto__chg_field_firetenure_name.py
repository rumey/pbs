...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FireTenure.name'
        db.alter_column(u'review_firetenure', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'FireTenure.name'
        db.alter_column(u'review_firetenure', 'name', self.gf('django.db.models.fields.CharField')(max_length=25))
