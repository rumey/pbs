...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OngoingBurn.ignition_type'
        db.delete_column(u'review_ongoingburn', 'ignition_type')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'OngoingBurn.ignition_type'
        raise RuntimeError("Cannot reverse this migration. 'OngoingBurn.ignition_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'OngoingBurn.ignition_type'
        db.add_column(u'review_ongoingburn', 'ignition_type',
