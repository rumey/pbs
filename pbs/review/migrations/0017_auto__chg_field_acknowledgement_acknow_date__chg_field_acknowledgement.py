...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Acknowledgement', fields ['burn', 'acknow_type']
        db.delete_unique(u'review_acknowledgement', ['burn_id', 'acknow_type'])


        # Changing field 'Acknowledgement.acknow_date'
        db.alter_column(u'review_acknowledgement', 'acknow_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
        ...
        # Changing field 'Acknowledgement.acknow_type'
        db.alter_column(u'review_acknowledgement', 'acknow_type', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Acknowledgement.acknow_date'
        raise RuntimeError("Cannot reverse this migration. 'Acknowledgement.acknow_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Acknowledgement.acknow_date'
        db.alter_column(u'review_acknowledgement', 'acknow_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # User chose to not deal with backwards NULL issues for 'Acknowledgement.user'
        raise RuntimeError("Cannot reverse this migration. 'Acknowledgement.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Acknowledgement.user'
        db.alter_column(u'review_acknowledgement', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # User chose to not deal with backwards NULL issues for 'Acknowledgement.acknow_type'
        raise RuntimeError("Cannot reverse this migration. 'Acknowledgement.acknow_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Acknowledgement.acknow_type'
        db.alter_column(u'review_acknowledgement', 'acknow_type', self.gf('django.db.models.fields.CharField')(max_length=64))
        # Adding unique constraint on 'Acknowledgement', fields ['burn', 'acknow_type']
        db.create_unique(u'review_acknowledgement', ['burn_id', 'acknow_type'])
