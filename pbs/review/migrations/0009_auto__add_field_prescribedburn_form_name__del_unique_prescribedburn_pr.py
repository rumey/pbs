...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PrescribedBurn', fields ['prescription', 'date', 'status']
        db.delete_unique(u'review_prescribedburn', ['prescription_id', 'date', 'status'])

        # Adding field 'PrescribedBurn.form_name'
        db.add_column(u'review_prescribedburn', 'form_name',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PrescribedBurn.form_name'
        db.delete_column(u'review_prescribedburn', 'form_name')

        # Adding unique constraint on 'PrescribedBurn', fields ['prescription', 'date', 'status']
        db.create_unique(u'review_prescribedburn', ['prescription_id', 'date', 'status'])
