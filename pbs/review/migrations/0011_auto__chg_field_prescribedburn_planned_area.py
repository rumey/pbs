...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PrescribedBurn.planned_area'
        db.alter_column(u'review_prescribedburn', 'planned_area', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=1))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PrescribedBurn.planned_area'
        raise RuntimeError("Cannot reverse this migration. 'PrescribedBurn.planned_area' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PrescribedBurn.planned_area'
        db.alter_column(u'review_prescribedburn', 'planned_area', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=1))
