...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnnualIndicativeBurnProgram.fin_yr'
        db.alter_column(u'review_annualindicativeburnprogram', 'fin_yr', self.gf('django.db.models.fields.CharField')(max_length=9, null=True))

    def backwards(self, orm):

        # Changing field 'AnnualIndicativeBurnProgram.fin_yr'
        db.alter_column(u'review_annualindicativeburnprogram', 'fin_yr', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))
