...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OngoingBurn.fire_region'
        db.delete_column(u'review_ongoingburn', 'fire_region')

        # Deleting field 'OngoingBurn.fire_id'
        db.delete_column(u'review_ongoingburn', 'fire_id')

        # Deleting field 'OngoingBurn.fire_desc'
        db.delete_column(u'review_ongoingburn', 'fire_desc')

        # Adding field 'OngoingBurn.fire'
        db.add_column(u'review_ongoingburn', 'fire',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fire', null=True, to=orm['review.Fire']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'OngoingBurn.fire_region'
        db.add_column(u'review_ongoingburn', 'fire_region',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'OngoingBurn.fire_id'
        db.add_column(u'review_ongoingburn', 'fire_id',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'OngoingBurn.fire_desc'
        db.add_column(u'review_ongoingburn', 'fire_desc',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'OngoingBurn.fire'
        db.delete_column(u'review_ongoingburn', 'fire_id')
    ...
    models = {
        ...
        u'review.ongoingburn': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'external_assist': ('django.db.models.fields.BooleanField', [], {}),
            'fire': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'fire'", 'null': 'True', 'to': u"orm['review.Fire']"}),
