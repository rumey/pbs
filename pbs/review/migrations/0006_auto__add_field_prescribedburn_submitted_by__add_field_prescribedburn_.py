...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'review_prescribedburn', 'submitted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='burn_submitted_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PrescribedBurn.endorsed_by'
        db.add_column(u'review_prescribedburn', 'endorsed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='burn_endorsed_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PrescribedBurn.approved_by'
        db.add_column(u'review_prescribedburn', 'approved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='burn_approved_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Fire.submitted_by'
        db.add_column(u'review_fire', 'submitted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fire_submitted_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Fire.endorsed_by'
        db.add_column(u'review_fire', 'endorsed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fire_endorsed_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Fire.approved_by'
        db.add_column(u'review_fire', 'approved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fire_approved_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Fire.approval_status'
        db.add_column(u'review_fire', 'approval_status',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Fire.approval_status_modified'
        db.add_column(u'review_fire', 'approval_status_modified',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Fire.submitted_by'
        db.delete_column(u'review_fire', 'submitted_by_id')

        # Deleting field 'Fire.endorsed_by'
        db.delete_column(u'review_fire', 'endorsed_by_id')

        # Deleting field 'Fire.approved_by'
        db.delete_column(u'review_fire', 'approved_by_id')

        # Deleting field 'Fire.approval_status'
        db.delete_column(u'review_fire', 'approval_status')

        # Deleting field 'Fire.approval_status_modified'
        db.delete_column(u'review_fire', 'approval_status_modified')
    ...
    models = {
        ...
        u'review.prescribedburn': {
            ...
            'approval_status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'approval_status_modified': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'approved_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'burn_approved_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'area': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '1', 'blank': 'True'}),
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            'endorsed_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'burn_endorsed_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            'submitted_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'burn_submitted_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
