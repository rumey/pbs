...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PrescribedBurn.planned_distance'
        db.add_column(u'review_prescribedburn', 'planned_distance',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=1, blank=True),
                      keep_default=False)

        # Adding field 'PrescribedBurn.distance'
        db.add_column(u'review_prescribedburn', 'distance',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=1, blank=True),
                      keep_default=False)

        # Adding field 'PrescribedBurn.planned_distance_unit'
        db.add_column(u'review_prescribedburn', 'planned_distance_unit',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PrescribedBurn.distance_unit'
        db.add_column(u'review_prescribedburn', 'distance_unit',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PrescribedBurn.planned_distance'
        db.delete_column(u'review_prescribedburn', 'planned_distance')

        # Deleting field 'PrescribedBurn.distance'
        db.delete_column(u'review_prescribedburn', 'distance')

        # Deleting field 'PrescribedBurn.planned_distance_unit'
        db.delete_column(u'review_prescribedburn', 'planned_distance_unit')

        # Deleting field 'PrescribedBurn.distance_unit'
        db.delete_column(u'review_prescribedburn', 'distance_unit')
    ...
    models = {
        ...
        u'review.prescribedburn': {
            ...
            'distance_unit': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'district': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': u"orm['prescription.District']", 'null': 'True', 'blank': 'True'}),
            ...
            'planned_distance_unit': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
