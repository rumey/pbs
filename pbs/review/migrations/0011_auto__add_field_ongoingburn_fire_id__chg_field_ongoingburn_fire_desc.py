...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OngoingBurn.fire_desc'
        db.alter_column(u'review_ongoingburn', 'fire_desc', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'OngoingBurn.fire_desc'
        db.alter_column(u'review_ongoingburn', 'fire_desc', self.gf('django.db.models.fields.CharField')(max_length=24, null=True))
