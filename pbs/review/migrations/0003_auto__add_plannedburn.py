...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'review_plannedburn', (
            ...
            ('area', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=7, decimal_places=1)),
            ('est_start', self.gf('django.db.models.fields.TimeField')()),
            ('has_contigency', self.gf('django.db.models.fields.BooleanField')()),
            ('has_monitoring', self.gf('django.db.models.fields.BooleanField')()),
