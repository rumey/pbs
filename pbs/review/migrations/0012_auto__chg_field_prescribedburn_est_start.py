...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PrescribedBurn.est_start'
        db.alter_column(u'review_prescribedburn', 'est_start', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PrescribedBurn.est_start'
        raise RuntimeError("Cannot reverse this migration. 'PrescribedBurn.est_start' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PrescribedBurn.est_start'
        db.alter_column(u'review_prescribedburn', 'est_start', self.gf('django.db.models.fields.TimeField')())
