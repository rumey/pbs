...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OngoingBurn'
        db.create_table(u'review_ongoingburn', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prescription', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ongoing_burn', to=orm['prescription.Prescription'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('ignition_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('burn_active', self.gf('django.db.models.fields.BooleanField')()),
            ...
            ('tenure', self.gf('django.db.models.fields.CharField')(max_length=24, null=True, blank=True)),
            ('external_assist', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'review', ['OngoingBurn'])


    def backwards(self, orm):
        # Deleting model 'OngoingBurn'
        db.delete_table(u'review_ongoingburn')
