...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BurnProgramLink.program_record'
        db.delete_column(u'review_burnprogramlink', 'program_record_id')

        # Adding field 'BurnProgramLink.wkb_geometry'
        db.add_column(u'review_burnprogramlink', 'wkb_geometry',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(default='MULTIPOLYGON(((1 1,5 1,5 5,1 5,1 1),(2 2, 3 2, 3 3, 2 3,2 2)))'),
                      keep_default=False)

        # Adding field 'BurnProgramLink.area_ha'
        db.add_column(u'review_burnprogramlink', 'area_ha',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'BurnProgramLink.longitude'
        db.add_column(u'review_burnprogramlink', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'BurnProgramLink.latitude'
        db.add_column(u'review_burnprogramlink', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'BurnProgramLink.perim_km'
        db.add_column(u'review_burnprogramlink', 'perim_km',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'BurnProgramLink.trtd_area'
        db.add_column(u'review_burnprogramlink', 'trtd_area',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


        # Changing field 'AnnualIndicativeBurnProgram.wkb_geometry'
        db.alter_column(u'review_annualindicativeburnprogram', 'wkb_geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BurnProgramLink.program_record'
        raise RuntimeError("Cannot reverse this migration. 'BurnProgramLink.program_record' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'BurnProgramLink.program_record'
        db.add_column(u'review_burnprogramlink', 'program_record',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.AnnualIndicativeBurnProgram']),
                      keep_default=False)

        # Deleting field 'BurnProgramLink.wkb_geometry'
        db.delete_column(u'review_burnprogramlink', 'wkb_geometry')

        # Deleting field 'BurnProgramLink.area_ha'
        db.delete_column(u'review_burnprogramlink', 'area_ha')

        # Deleting field 'BurnProgramLink.longitude'
        db.delete_column(u'review_burnprogramlink', 'longitude')

        # Deleting field 'BurnProgramLink.latitude'
        db.delete_column(u'review_burnprogramlink', 'latitude')

        # Deleting field 'BurnProgramLink.perim_km'
        db.delete_column(u'review_burnprogramlink', 'perim_km')

        # Deleting field 'BurnProgramLink.trtd_area'
        db.delete_column(u'review_burnprogramlink', 'trtd_area')


        # Changing field 'AnnualIndicativeBurnProgram.wkb_geometry'
        db.alter_column(u'review_annualindicativeburnprogram', 'wkb_geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=4283, null=True))
