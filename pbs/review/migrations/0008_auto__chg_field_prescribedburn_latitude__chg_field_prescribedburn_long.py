...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PrescribedBurn.longitude'
        db.alter_column(u'review_prescribedburn', 'longitude', self.gf('django.db.models.fields.FloatField')(default=1))

    def backwards(self, orm):

        # Changing field 'PrescribedBurn.latitude'
        db.alter_column(u'review_prescribedburn', 'latitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=5))

        # Changing field 'PrescribedBurn.longitude'
        db.alter_column(u'review_prescribedburn', 'longitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=5))
