...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OngoingBurn.fire_region'
        db.alter_column(u'review_ongoingburn', 'fire_region', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'OngoingBurn.fire_region'
        raise RuntimeError("Cannot reverse this migration. 'OngoingBurn.fire_region' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'OngoingBurn.fire_region'
        db.alter_column(u'review_ongoingburn', 'fire_region', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
    ...
    models = {
        ...
        u'review.ongoingburn': {
            ...
            'fire_desc': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'fire_id': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'fire_region': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
