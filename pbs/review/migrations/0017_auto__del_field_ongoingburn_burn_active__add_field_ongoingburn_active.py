...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OngoingBurn.burn_active'
        db.delete_column(u'review_ongoingburn', 'burn_active')

        # Adding field 'OngoingBurn.active'
        db.add_column(u'review_ongoingburn', 'active',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'OngoingBurn.burn_active'
        raise RuntimeError("Cannot reverse this migration. 'OngoingBurn.burn_active' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'OngoingBurn.burn_active'
        db.add_column(u'review_ongoingburn', 'burn_active',
                      self.gf('django.db.models.fields.BooleanField')(),
                      keep_default=False)

        # Deleting field 'OngoingBurn.active'
        db.delete_column(u'review_ongoingburn', 'active')
    ...
    models = {
        ...
        u'review.fire': {
            ...
            'fire_active': ('django.db.models.fields.BooleanField', [], {}),
