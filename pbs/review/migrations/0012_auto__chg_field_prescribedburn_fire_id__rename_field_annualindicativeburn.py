...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AnnualIndicativeBurnProgram.ogc_fid'
        db.rename_column(u'review_annualindicativeburnprogram', 'ogc_fid', 'objectid')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AnnualIndicativeBurnProgram.objectid'
        db.rename_column(u'review_annualindicativeburnprogram', 'objectid', 'ogc_fid')
    ...
    models = {
        ...
        u'review.prescribedburn': {
            ...
            'fire_id': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
