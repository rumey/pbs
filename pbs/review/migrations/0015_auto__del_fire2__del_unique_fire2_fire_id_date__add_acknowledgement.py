...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'review_acknowledgement', (
            ...
            ('acknow_type', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('acknow_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'review_fire2', (
            ...
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submitted_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fire_submitted_by', null=True, to=orm['auth.User'], blank=True)),
            ...
            ('endorsed_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fire_endorsed_by', null=True, to=orm['auth.User'], blank=True)),
            ('approved_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fire_approved_by', null=True, to=orm['auth.User'], blank=True)),
    ...
    models = {
        ...
        u'review.acknowledgement': {
            ...
            'acknow_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'acknow_type': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
