...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OngoingBurn.prescription'
        db.alter_column(u'review_ongoingburn', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['prescription.Prescription']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'OngoingBurn.prescription'
        raise RuntimeError("Cannot reverse this migration. 'OngoingBurn.prescription' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'OngoingBurn.prescription'
        db.alter_column(u'review_ongoingburn', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))
