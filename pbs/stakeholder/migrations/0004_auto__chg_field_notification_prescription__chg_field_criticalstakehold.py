...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notification.prescription'
        db.alter_column(u'stakeholder_notification', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'CriticalStakeholder.prescription'
        db.alter_column(u'stakeholder_criticalstakeholder', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

        # Changing field 'PublicContact.prescription'
        db.alter_column(u'stakeholder_publiccontact', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Notification.prescription'
        db.alter_column(u'stakeholder_notification', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'CriticalStakeholder.prescription'
        db.alter_column(u'stakeholder_criticalstakeholder', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))

        # Changing field 'PublicContact.prescription'
        db.alter_column(u'stakeholder_publiccontact', 'prescription_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prescription.Prescription']))
    ...
    models = {
        ...
        u'stakeholder.notification': {
            ...
            'contacted': ('django.db.models.fields.TextField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
