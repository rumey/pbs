...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notification.address'
        db.alter_column(u'stakeholder_notification', 'address', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Notification.address'
        db.alter_column(u'stakeholder_notification', 'address', self.gf('django.db.models.fields.CharField')(max_length=320))
    ...
    models = {
        ...
        u'stakeholder.notification': {
            ...
            'notified': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
