...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Notification.stakeholder'
        db.delete_column(u'stakeholder_notification', 'stakeholder_id')

        # Adding field 'Notification.contacted'
        db.add_column(u'stakeholder_notification', 'contacted',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Notification.organisation'
        db.add_column(u'stakeholder_notification', 'organisation',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Notification.address'
        db.add_column(u'stakeholder_notification', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=320),
                      keep_default=False)

        # Adding field 'Notification.phone'
        db.add_column(u'stakeholder_notification', 'phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=320),
                      keep_default=False)

        # Deleting field 'PublicContact.comment'
        db.delete_column(u'stakeholder_publiccontact', 'comment')

        # Deleting field 'PublicContact.stakeholder'
        db.delete_column(u'stakeholder_publiccontact', 'stakeholder_id')

        # Adding field 'PublicContact.name'
        db.add_column(u'stakeholder_publiccontact', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=320),
                      keep_default=False)

        # Adding field 'PublicContact.organisation'
        db.add_column(u'stakeholder_publiccontact', 'organisation',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'PublicContact.person'
        db.add_column(u'stakeholder_publiccontact', 'person',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'PublicContact.comments'
        db.add_column(u'stakeholder_publiccontact', 'comments',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Notification.stakeholder'
        raise RuntimeError("Cannot reverse this migration. 'Notification.stakeholder' and its values cannot be restored.")
        # Deleting field 'Notification.contacted'
        db.delete_column(u'stakeholder_notification', 'contacted')

        # Deleting field 'Notification.organisation'
        db.delete_column(u'stakeholder_notification', 'organisation')

        # Deleting field 'Notification.address'
        db.delete_column(u'stakeholder_notification', 'address')

        # Deleting field 'Notification.phone'
        db.delete_column(u'stakeholder_notification', 'phone')


        # User chose to not deal with backwards NULL issues for 'PublicContact.comment'
        raise RuntimeError("Cannot reverse this migration. 'PublicContact.comment' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PublicContact.stakeholder'
        raise RuntimeError("Cannot reverse this migration. 'PublicContact.stakeholder' and its values cannot be restored.")
        # Deleting field 'PublicContact.name'
        db.delete_column(u'stakeholder_publiccontact', 'name')

        # Deleting field 'PublicContact.organisation'
        db.delete_column(u'stakeholder_publiccontact', 'organisation')

        # Deleting field 'PublicContact.person'
        db.delete_column(u'stakeholder_publiccontact', 'person')

        # Deleting field 'PublicContact.comments'
        db.delete_column(u'stakeholder_publiccontact', 'comments')
    ...
    models = {
        ...
        u'stakeholder.notification': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'max_length': '320'}),
            'contacted': ('django.db.models.fields.TextField', [], {'default': 'datetime.datetime.now'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            ...
            'organisation': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '320'}),
            'prescription': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['prescription.Prescription']"})
        },
        u'stakeholder.publiccontact': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '320'}),
            'organisation': ('django.db.models.fields.TextField', [], {}),
